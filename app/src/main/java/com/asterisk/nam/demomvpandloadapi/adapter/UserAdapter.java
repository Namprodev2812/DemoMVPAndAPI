...
public class UserAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int i) {
        if (mFeelViewHolder) {
            Log.e("UserAdapter","onBindViewHolder----"+mFeelViewHolder+ "viewholder: "+i);
            UserAdapter.ViewHolder viewHolders = (UserAdapter.ViewHolder) viewHolder;
            viewHolders.bindData(i);
        } else if (!mFeelViewHolder){
            Log.e("UserAdapter","onBindViewHolder----"+mFeelViewHolder+ "viewHolder1: "+i);
            //UserAdapter.ViewHolder1 viewHolders = (UserAdapter.ViewHolder1) viewHolder;
        }
    }
